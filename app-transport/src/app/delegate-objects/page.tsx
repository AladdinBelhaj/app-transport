...
const DelegateObjects = () => {
  const currentTripString = localStorage.getItem("trip");
  let parsedTrip;
  if (currentTripString !== null) {
    parsedTrip = JSON.parse(currentTripString);
    const currentTripId = parsedTrip.id;
...
export default DelegateObjects;
