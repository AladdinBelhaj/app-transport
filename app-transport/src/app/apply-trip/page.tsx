...
//         <div key={accordion.id} className="collapse collapse-plus bg-base-200">
//           {accordions.length > 1 && (
//             <button
...
//             checked={activeAccordion === accordion.id}
//             onChange={() => handleAccordionClick(accordion.id)}
//           />
//           <label
...
//       ))}
//       <button
//         className="fixed bottom-4 right-4 rounded bg-blue-500 px-4 py-2 font-semibold text-white hover:bg-blue-600"
